...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    private List<PostHolder> postHolderListFull;


    public PostAdapter() {}
    public PostAdapter(List<PostHolder> postHolderList) {
        this.postHolderList = postHolderList;
        postHolderListFull = new ArrayList<>(postHolderList);
        Log.e("zzz21", "" + postHolderListFull.size());
    }
    ...
    public void onBindViewHolder(@NonNull final PostViewHolder holder, final int position) {
        ...
        // checks the tags
        if (postHolder.getTags() == null || postHolder.getTags().get(0).equals("")) {

            holder.tv_tags.setText("No Tag");

        } else {

            holder.tv_tags.setText("Tags: " + TextUtils.join(", ", postHolder.getTags()));
    ...
    public void addUserToPostLikers(final PostHolder postHolder, final ImageView imageView, final TextView textView) {
        ...
        writeBatch.set(postLikersCollection.document(), liker);
