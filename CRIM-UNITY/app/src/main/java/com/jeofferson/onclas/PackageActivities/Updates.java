...
public class Updates extends AppCompatActivity implements BottomSheetDialogUpdate.BottomSheetDialogListener {
        ...
        postsCollection.document(postId).get()
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        // checks the tags
                        if (post.getTags() == null || post.getTags().get(0).equals("")) {

                            tv_tags.setText("No Tag");

                        } else {

                            tv_tags.setText("Tags: " + TextUtils.join(", ", post.getTags()));

                        }

                        // checks if there's no description...
                        if (post.getPostContent().trim().isEmpty()) {
    ...
    public void setUpAdapter() {
        ...
        commentAdapter = new CommentAdapter(commentHolderList, postHolderId, postId, post.getPoster1Id());
    ...
    public void addCommentToDatabase() {
        ...
        comment = new Comment(commentOnId, commenter1Id, commenter2Id, commenterPicture, commenter1Name, commenter2Name, commentContent, dateCreated, commentPicture, false);
        commentHolder = new CommentHolder(commentOnId, commentUid, commenter1Id, commenter2Id, commenterPicture, commenter1Name, commenter2Name, commentContent, dateCreated, commentPicture, false);
